...
data_path = "d:/serialize/crazy/data"
...
W_conv9 = weight_variable([3, 3, 64, 32])
b_conv9 = bias_variable([32])
W_conv10 = weight_variable([3, 3, 32, 16])
b_conv10 = bias_variable([16])
...
h_pool2_flat = tf.reshape(h_conv10, [-1, 1440])	#降维打击
...
train_step = tf.train.AdadeltaOptimizer(3).minimize(loss)
